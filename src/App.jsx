...
function App() {
  ...
  const projects = [
    ...
    {
      kind: 'video',
      src: '/portfolio/shopify-filter-demo.mp4',
      type: 'video/mp4',
      title: 'Shopify Filter & Variant Demo',
      subtitle: 'VIDEO CASE STUDY • 2026',
      projectUrl: 'https://example.com/shopify-filter-variant-demo',
      text: 'Walkthrough showing custom filter interactions and variant-selection experience in a Shopify storefront.',
      tags: ['Shopify', 'Filter', 'Variant UX'],
    },
    {
      kind: 'video',
