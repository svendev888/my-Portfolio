  ...
  const projects = [
    {
      ...
      subtitle: 'B2C Volvo parts ecommerce platform with optimized catalog UX, technical SEO, and performance-focused frontend delivery.',
    ...
    },
    {
      ...
      subtitle: 'Automotive parts storefront engineered for high-intent navigation, conversion-oriented UX, and scalable SEO structure.',
    ...
    },
    {
      ...
      subtitle: 'Corporate service website built on a CMS-first architecture with structured content flows and lead-generation UX.',
    ...
    },
    {
      ...
      subtitle: 'Local restoration services site designed for urgent customer journeys, trust signaling, and action-driven conversion paths.',
    ...
    },
    {
      ...
      subtitle: 'Custom-coded Shopify product detail page focused on merchandising clarity, persuasive content blocks, and checkout readiness.',
    ...
    },
    {
      ...
      subtitle: 'End-to-end Shopify PDP redesign centered on information hierarchy, CRO experimentation, and mobile-first purchase flow.',
    ...
    },
    {
      ...
      subtitle: 'Shopify variant-selection implementation with custom option logic, improved discoverability, and smoother cross-device UX.',
          ...
          <div className="about-skills">
            <div className="skill-box skill-box--grow">
              ...
              <p>
                ...
                <strong>Auth &amp; data:</strong> OAuth2, JWT, PostgreSQL, MongoDB<br />
